...
export default function MyReportsScreen() {
  ...
  const [filter, setFilter] = useState<"All" | "In Progress" | "Resolved">(
    "All",
  );
          ...
          {filteredReports.map((report) => {
            ...
            return (
              <Pressable
                ...
                onPress={() =>
                  router.push(
                    `/report-tracking/${encodeURIComponent(report.id)}`,
                  )
                }
              >
                <Image
                  source={{ uri: getCdnUrl(report.photos[0]) }}
                  style={styles.thumb}
                />
                <View style={styles.cardBody}>
                  <View style={styles.cardHeader}>
                    ...
                    >
                      <Text
                        style={[
                          styles.badgeText,
                          { color: isResolved ? "#2F9E5C" : "#E3A93A" },
                        ]}
                      >
                        {report.status}
                      </Text>
                  ...
                  <Text style={styles.dateText}>
                    {report.reportedDate}, {report.reportedTime}
                  </Text>
                </View>
              </Pressable>
            );
